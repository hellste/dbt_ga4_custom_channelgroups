...
with ga4_unnested_pageview_event_data as(
    ...
    select
        ...
        {{ unnest_key_with_null_default('event_params', 'session_gadscampaign') }} as session_gadscampaign,
        {{ unnest_key_with_null_default('event_params', 'session_gadsbraid') }} as session_gadsbraid,
